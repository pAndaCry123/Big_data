...
@app.route('/get_group_b_test_prep')
...
@app.route('/get_group_b_writting')
...
@app.route('/get_group_b_diff_read_write')
...
@app.route('/get_group_b_diff_math_write')
...
@app.route('/get_group_b_diff_math_read')
