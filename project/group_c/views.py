...
@app.route('/get_group_c_test_prep')
...
@app.route('/get_group_c_writting')
...
@app.route('/get_group_c_diff_read_write')
...
@app.route('/get_group_c_diff_math_write')
...
@app.route('/get_group_c_diff_math_read')
