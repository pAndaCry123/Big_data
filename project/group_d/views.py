...
@app.route('/get_group_d_test_prep')
...
@app.route('/get_group_d_writting')
...
@app.route('/get_group_d_diff_read_write')
...
@app.route('/get_group_d_diff_math_write')
...
@app.route('/get_group_d_diff_math_read')
